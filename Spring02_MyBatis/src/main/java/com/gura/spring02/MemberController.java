...
public class MemberController {
	...
	public String insert(MemberDto dto) { // 폼 전송되는 name, addr 이 자동으로 추출되어 MemberDto 에 담겨 전달된다.
		dao.insert(dto);
	...
	public String insertform() {
		...
		// /WEB-INF/views/member/inserform.jsp 로 forward 이동해서 응답
