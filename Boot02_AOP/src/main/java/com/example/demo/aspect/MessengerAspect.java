...
public class MessengerAspect {
	   ...
	   public void checkGreeting(ProceedingJoinPoint joinPoint) throws Throwable{
		  ...
		  // aspect 가 적용된 메소드가 호출 되기 직전에 할 작업은 여기서한다.
	    ...
	    *  get 으로 시작하는 메소드 이고
	    *  메소드에 전달되는 인자는 없다 
	    *  java.lang 페키지에 있는 type 은 패키지 명 생략 가능
	    */
	   
	   // Before 와 After 를 합친것과 비슷하지만 보다 많은 기능이 있음
	   ...
	   public Object checkReturn(ProceedingJoinPoint joinPoint) throws Throwable {
		  ...
		  // joinPoint.proceed 메소드를 호출해야 getMessage 메소드가 수행된다.
	      Object obj = joinPoint.proceed();
	      
	      // 원래 type 으로 casting 해서 조사해 볼수가 있다.
	      String a = (String)obj;

	      // 조사 후 다른 값을 리턴해줄 수도 있다. 
	      return "놀자놀자!";
	   }
}
